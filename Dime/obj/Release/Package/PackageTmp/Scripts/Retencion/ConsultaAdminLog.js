...
function TraerDatosConsulta(F1, F2) {
    ...
    $.ajax({
        type: "GET",
        url: urlconsultalogadminretencion,
...
function cargargrilla(data) {
    $("#gridViewConsulta").kendoGrid({
        ...
        toolbar: ["excel"],
        excel: {
            fileName: "SeguimientosRetencionLog.xlsx",
            allPages: true
        },
        dataSource: {
            data: data,
        ...
        { field: "AliadoTransaccion", title: "Aliado Transaccion", width: 100 },
        { field: "OperacionTransaccion", title: "Operacion Transaccion", width: 100 },
        { field: "LineaTransaccion", title: "Linea Transaccion", width: 100 },
