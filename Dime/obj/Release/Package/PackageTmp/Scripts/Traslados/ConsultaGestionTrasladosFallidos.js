function cambiarfechas() {
    for (var i = 0; i < jsonsegcdout.length; i++) {
        jsonsegcdout[i].TrasladoFallido.FechaTransaccion = kendo.toString(kendo.parseDate(jsonsegcdout[i].TrasladoFallido.FechaTransaccion, 'yyyy-MM-dd HH:mm:ss'), 'yyyy-MM-dd HH:mm:ss');
