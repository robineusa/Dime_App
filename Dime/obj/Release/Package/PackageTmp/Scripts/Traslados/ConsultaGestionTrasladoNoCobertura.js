...
function ActualizarCaso(e) {
    ...
    if (dataItem.NotaTrasladoGetSet.Razon == "GESTION BACKOFFICE") {
        window.location.href = 'GestionarTrasladoNoCobertura?id=' + dataItem.NotaTrasladoGetSet.IdTransaccion;
    }
    else if (dataItem.NotaTrasladoGetSet.Razon == "GESTION INBOUND") {
        window.location.href = 'ConsultaGestionTrasladoNoCobertura';
    }
