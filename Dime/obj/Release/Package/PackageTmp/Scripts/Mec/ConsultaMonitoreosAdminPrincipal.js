...
function cargargrilla(data) {
    $("#gridViewConsulta").kendoGrid({
        ...
        toolbar: ["excel"],
        excel: {
            fileName: "MonitoreosMecPrincipal.xlsx",
        },
        dataSource: {
            data: data,
        },
        ...
        columns: [
        //{ command: { text: " ", click: ActualizarCaso, imageClass: "fa fa-fw fa-pencil-square-o", }, title: " ", width: "60px" },
