$("#gridViewSolicitudescreaciondeMatrices").kendoGrid({
    dataSource: {
        data: jsonSolicitudesCreaciondeMatrices,
        pageSize: 10,
    },
    scrollable: true,
    filterable: {
...
function ActualizarCaso(e) {
    ...
    window.location.href = '/Traslados/GestionarCreacionDeMatriz?id=' + dataItem.IngresoTrasladoGetSet.IdTransaccion;
}