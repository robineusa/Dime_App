$("#gridViewSolicitudesgestiondeMatrices").kendoGrid({
    dataSource: {
        data: jsonSolicitudesgestiondeMatrices,
        pageSize: 10,
    },
    scrollable: true,
    filterable: {
...
function ActualizarCaso(e) {
    ...
    window.location.href = '/Traslados/GestionMatricesCelula?id=' + dataItem.IngresoTrasladoGetSet.IdTransaccion;
}