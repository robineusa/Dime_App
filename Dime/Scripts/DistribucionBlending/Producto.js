...
function ListaTipoDeContacto() {
    $.ajax({
        ...
        data: JSON.stringify({ gestion: 13 }),
        dataType: "JSON",
...
function ActualizarCaso(e) {
    ...
    window.location.href = 'Producto?CuentaCliente=' + dataItem.CuentaCliente;
}
...
function ActualizarCasoSeg(e) {
    ...
    var dataItem = this.dataItem($(e.currentTarget).closest("tr"));
    var seg = "Ture";
    window.location.href = 'Producto?CuentaCliente=' + dataItem.CuentaCliente + '&Seg=' + seg;
}
