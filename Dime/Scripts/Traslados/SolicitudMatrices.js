...
$('#tipogestionmatriz').change(function () {
    ValidarTipoGestionMatriz();
})
...
function ValidarTipoGestionMatriz() {
     if ($('#tipogestionmatriz').val() == '--SELECCIONE--') {
        
        $('#cuentamatriz').prop('readonly', true);
        $('#ordendetrabajo').prop('readonly', true);
        $('#nombreconjuntoedificio').prop('readonly', true);
        $('#telefonoadministrador').prop('readonly', true);
        $('#telefonocliente').prop('readonly', true);
        $('#nombreadministrador').prop('readonly', true);

    }
    else
         if ($('#tipogestionmatriz').val() == 'CREAR MATRIZ') {
             var val1 = "0";
             var val2 = "NO APLICA";

             $('#cuentamatriz').prop('readonly', true); $('#cuentamatriz').val(val1);
             $('#ordendetrabajo').prop('readonly', true); $('#ordendetrabajo').val(val1);
             $('#nombreconjuntoedificio').prop('readonly', false); $('#nombreconjuntoedificio').val("");
             $('#telefonoadministrador').prop('readonly', false); $('#telefonoadministrador').val("");
             $('#telefonocliente').prop('readonly', false); $('#telefonocliente').val("");
             $('#nombreadministrador').prop('readonly', false); $('#nombreadministrador').val("");


        }
        else
            if ($('#tipogestionmatriz').val() == 'GESTIONAR MATRIZ') {
                $('#cuentamatriz').prop('readonly', false); $('#cuentamatriz').val(val1);
                $('#ordendetrabajo').prop('readonly', false); $('#ordendetrabajo').val(val1);
                $('#nombreconjuntoedificio').prop('readonly', true); $('#nombreconjuntoedificio').val("NO APLICA");
                $('#telefonoadministrador').prop('readonly', true); $('#telefonoadministrador').val("NO APLICA");
                $('#telefonocliente').prop('readonly', true); $('#telefonocliente').val("NO APLICA");
                $('#nombreadministrador').prop('readonly', true); $('#nombreadministrador').val("NO APLICA");
            } else {
                $('#cuentamatriz').prop('readonly', true);
                $('#ordendetrabajo').prop('readonly', true);
                $('#nombreconjuntoedificio').prop('readonly', true);
