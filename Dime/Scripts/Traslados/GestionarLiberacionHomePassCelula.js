...
function CambiarEstado() {
    if ($("#Subrazon").val() == "CLIENTE QUE OCUPA AUN NO TOMA DECISION" || $("#Subrazon").val() == "CLIENTE QUE OCUPA NO BRINDA INFORMACION" || $("#Subrazon").val() == "CUENTA QUE OCUPA ESCALADA A CANCELACIONES" || $("#Subrazon").val() == "CUENTA QUE OCUPA SE TRASLADA A  MATRIZ SIN CABLEADO" || $("#Subrazon").val() == "OT CREADA CUENTA QUE OCUPA" || $("#Subrazon").val() == "NO CONTACTO CLIENTE QUE OCUPA" || $("#Subrazon").val() == "NO CONTACTO CLIENTE QUE  TRASLADA" || $("#Subrazon").val() == "CLIENTE EN MORA" || $("#Subrazon").val() == "CLIENTE QUE OCUPA SOLICITA CANCELACION  NO  ES TITULAR" || $("#Subrazon").val() == "CLIENTE QUE OCUPA SE TRASLADA  AUN NO TIENE DIRECCION" || $("#Subrazon").val() == "CUENTA QUE OCUPA  SUSPENDIDA TEMPORALMENTE") {
        ...
        if ($("#Subrazon").val() == "CLIENTE QUE TRASLADA DESISTE DE PROCESO" || $("#Subrazon").val() == "CLIENTE QUE TRASLADA SOLICITO CANCELACION" || $("#Subrazon").val() == "CLIENTE QUE TRASLADA  CEDIO EL CONTRATO" || $("#Subrazon").val() == "ESCALAMIENTO ERRADO" || $("#Subrazon").val() == "OT CREADA CUENTA QUE TRASLADA" || $("#Subrazon").val() == "CLIENTE QUE TRASLADA DESISTE DE PROCESO HH PP LIBRE" || $("#Subrazon").val() == "CLIENTE QUE TRASLADA DESISTE DE PROCESO HH PP OCUPADO" || $("#Subrazon").val() == "HH PP LIBRE NO CONTACTO CLIENTE QUE TRASLADA" || $("#Subrazon").val() == "MORA CUENTA QUE TRASLADA" || $("#Subrazon").val() == "TRASLADO A OTRA DIRECCION" || $("#Subrazon").val() == "TRASLADO OK" || $("#Subrazon").val() == "CUENTA ESCALADA A OTRO PROCESO" || $("#Subrazon").val() == "01 CLIENTE DESISTE DEL TRASLADO" || $("#Subrazon").val() == "02 NO CONTACTO CON EL CLIENTE" || $("#Subrazon").val() == "03 SOLICITUD DE TRASLADO ERRADA") {
            $("#estado").empty();
